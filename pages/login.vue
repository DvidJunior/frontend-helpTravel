        ...
        <div class="signin-max-width max-content-container">
          <div class="signin-container-form">
            <div class="signin-title">
              <h3 class="signin-text">Welcome back</h3>
              <p class="signin-text1">Enter your email and password to sign in</p>
            </div>
            <form @submit.prevent="login" class="signin-form">
              <label class="signin-label">Email</label>
              <input type="email" id="usuario" v-model="email" placeholder="Email" required autofocus class="signin-textinput input" />
              <label class="signin-label1">Password</label>
              <input type="password" id="password" v-model="password" placeholder="Password" required autofocus class="signin-textinput1 input" />
              <div class="signin-max-whidth-bottun">
                <button type="submit" class="signin-button button">Sign in</button>
              </div>
            </form>
            <div class="signin-container-link">
              <span class="signin-text2">Don&apos;t have an account?</span>
              <span class="signin-text3"> Sing up</span>
            </div>
          </div>
